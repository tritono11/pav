    ...
    <div class="row">
        <div class="col-md-12 2">
            <div class="panel panel-default">
                <ol class="breadcrumb">
                    <li><a href="/">Home</a></li>
                    <li><a href="/roles/list">@Lang('role.roles')</a></li>
                    <li class="active">@Lang('role.edit')</li>
                </ol>
                <div class="panel-heading">@Lang('role.edit')</div>
                <div class="panel-body">
                    ...
                    {{ Form::open(array( 'class' => 'form-horizontal')) }}
                        ...
                        <div class="form-group {{ $errors->has('guard_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('guard_name', $role->guard_name, array('class' => 'form-control', 'required' => 'required')) }}
