    ...
    <div class="row">
        <div class="col-md-12 2">
            <div class="panel panel-default">
                ...
                <div class="alert alert-info guida-miniatura" role="alert">{{__('profilo.ex1')}}</div>
                <div class="panel-body">
                    ...
                    {{ Form::open(array('route' => array('profilo.update', $profilo->id), 'class' => 'form-horizontal')) }}
                        ...
                        <div class="form-group {{ $errors->has('d_nascita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::date('d_nascita', Carbon::parse($profilo->d_nascita)->format('Y-m-d'), array('class' => 'form-control') )  }}
                        ...
                        <div class="form-group {{ $errors->has('t_provincia_nascita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('t_provincia_nascita', $provinciaDDL, $profilo->t_provincia_nascita, array('class' => 'form-control', 'id' => 't_provincia_nascita', 'data-url' => '../../istat/comuni/' )) }}
                        ...
                        <div class="form-group {{ $errors->has('t_comune_nascita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('t_comune_nascita', $comuneDDL, $profilo->t_comune_nascita, array('class' => 'form-control', 'id' => 't_comune_nascita')) }}
                                @if ($errors->has('t_comune_nascita'))
                                    <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('t_regione_res') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('t_regione_res', $regioni, $profilo->t_regione_res, array('class' => 'form-control', 'id' => 't_regione_res', 'data-url' => '../istat/province/' )) }}
                        ...
                        <div class="form-group {{ $errors->has('t_provincia_res') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('t_provincia_res', $provinciaResDDL, $profilo->t_provincia_res, array('class' => 'form-control', 'id' => 't_provincia_res', 'data-url' => '../../istat/comuni/' )) }}
                        ...
                        <div class="form-group {{ $errors->has('t_comune_res') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('t_comune_res', $comuneResDDL, $profilo->t_comune_res, array('class' => 'form-control', 'id' => 't_comune_res')) }}
