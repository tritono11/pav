                ...
                <div class="panel-body">
                    ...
                    {{ Form::open(array('route' => 'profilo.store', 'class' => 'form-horizontal')) }}
                        <div class="form-group {{ $errors->has('t_nome') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_nome', old('t_nome'), array('class' => 'form-control', 'required' => 'required')) }}
                        ...
                        <div class="form-group {{ $errors->has('t_cognome') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_cognome', old('t_cognome'), array('class' => 'form-control', 'required' => 'required')) }}
                        ...
                        <div class="form-group {{ $errors->has('t_sesso') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::select('t_sesso', array('M' => __('profilo.sesso.maschio'), 'F' => __('profilo.sesso.femmina')), old('t_sesso'), array('class' => 'form-control')) }}
                        ...
                        <div class="form-group {{ $errors->has('t_cf') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_cf', old('t_cf'), array('class' => 'form-control', 'maxlength' => '16') )  }}
                                @if ($errors->has('t_cf'))
                                    <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('t_piva') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_piva', old('t_piva'), array('class' => 'form-control', 'maxlength' => '11') )  }}
                        ...
                        <div class="form-group {{ $errors->has('t_ci') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_ci', old('t_ci'), array('class' => 'form-control') )  }}
                                @if ($errors->has('t_ci'))
                                    <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('t_patente') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_patente', old('t_patente'), array('class' => 'form-control') )  }}
                        ...
                        <div class="form-group {{ $errors->has('t_telefono') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                {{ Form::text('t_telefono', old('t_telefono'), array('class' => 'form-control') )  }}
